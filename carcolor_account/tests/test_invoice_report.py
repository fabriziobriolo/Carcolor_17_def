...
class TestInvoiceReport(TransactionCase):
    ...
    def test_invoice_report_data_structure(self):
        ...
        # Verifica la struttura principale
        self.assertIn('d', json_data)
        self.assertIn('company', json_data['d'])
        self.assertIn('partner', json_data['d'])
        self.assertIn('lines', json_data['d'])
        
        # Verifica i dati del company
        company_data = json_data['d']['company']
        ...
        partner_data = json_data['d']['partner']
